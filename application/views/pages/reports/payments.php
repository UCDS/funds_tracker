	...
	<script>
		...
		.controller('Bank_bookCtrl', ['$http',"formatDataFilter","DateFormater", function($http,formatData,DateFormater) {
			...
			if(sessionStorage.getItem("from")) {
				self.searchBank_book.fromdate = DateFormater.convertToJSDate(sessionStorage.getItem("from"));
			}else {
			...
			if(sessionStorage.getItem("to")) {
				self.searchBank_book.todate = DateFormater.convertToJSDate(sessionStorage.getItem("to"));
			}else {
			...
			self.searchBankBooks = function(){
				...
				if(!self.PreDefTrnxType){
					...
					sessionStorage.setItem("from", tempDetails.fromdate);
					sessionStorage.setItem("to", tempDetails.todate);
			...
			self.AttachFiles = function(vBook){
				...
				vNewForm += '<input type="hidden" name="view" value="'+vBook.view+'" />';
			  	vNewForm += "</form>";
