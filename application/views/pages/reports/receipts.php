...
<div ng-app="bank_booksApp">
	<div ng-controller ="Bank_bookCtrl as bank_bookCtrl">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-yellow ">
				<div class="panel-heading">Receipt Transactions</div>
					...
					<table class="table tableevenodd table-hover" style="font-size: 11px;">
						<thead>
							<tr>
								...
								<?php if ($session_data['logged_in'] == 'YES' && !empty($session_data['user_id'])) { ?>
						...
						<tbody>
							<tr ng-repeat="bank_book in bank_bookCtrl.bank_books" > 
								...
								<?php if ($session_data['logged_in'] == 'YES' && !empty($session_data['user_id'])) { ?>
								<td>
									<span class="file-count-icon" title="Attachments" ng-click="bank_bookCtrl.AttachFiles(bank_book)">
										<i aria-hidden="true" class="fa fa-file-o "></i>
										<span class="file-count" ng-bind="bank_book.attachments_count"></span>
									</span>
									<input type="button" value="Receipt Voucher" ng-click="bank_bookCtrl.PrintVoucher(bank_book)"/>
	...
	<script>
		...
		.controller('Bank_bookCtrl', ['$http',"formatDataFilter","DateFormater", function($http,formatData,DateFormater) {
			var self = this;
			$("#LefNaveReceiptsReport").addClass("active");
			...
			self.AttachFiles = function(vBook){
				...
				vNewForm += '<input type="hidden" name="Module" value="ReceiptsReport" />';
