...
class Upload extends CI_Controller{
    ...
    function index(){
		...
		$this->session->set_userdata('PaymentVoucherNumber', $this->data['PaymentVoucherNumber']);
		$this->data['session_view'] = $this->upload_model->getviewval();
		$this->data['view'] = $this->input->post('view');
...
//		}
	...
	function toggle_public_private()
	{
		// Make sure the parameters are being passed via POST.
		$tranxID = $this->input->post('tranxID');
		$val = $this->input->post('val');

		$this->upload_model->updateviewvalue($tranxID, $val);
	}
